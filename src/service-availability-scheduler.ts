...
app.use((_req, res, next) => {
  ...
  res.setHeader(
    ...
    [
      'default-src \'self\'',
      'script-src \'self\' \'unsafe-inline\' \'unsafe-eval\' https://accounts.google.com/gsi/client https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/',
      'style-src \'self\' \'unsafe-inline\'',
      'img-src \'self\' data: https://*.googleusercontent.com',
      'connect-src \'self\' https://accounts.google.com https://www.google.com/recaptcha/',
